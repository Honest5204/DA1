...
public class ManageTrackAdapter extends RecyclerView.Adapter<ManageTrackAdapter.ViewHolder> {
    ...
    public ManageTrackAdapter(Context context, List<Tracks> list) {
    ...
    private void showDeleteConfirmationDialog(int position) {
        ...
        builder.setPositiveButton("Xóa", (dialog, which) -> {
            ...
            deleteTrackFromAllUsers(position);
        });
    ...
    private void deleteTrackFromAllUsers(int position) {
        ...
        usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                    ...
                    deleteTrackFromUser(userId, list.get(position).getId());
                }
            }
